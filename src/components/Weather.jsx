  ...
  return (
    <section>
        ...
        <section className="grid gap-4 sm:grid-cols-two">
            ...
            <article className="bg-slate-300/70 rounded-3xl grid grid-cols-2 justify-items-center items-center py-2 s,:px-2">
            ...
            <article className="bg-slate-300/70 rounded-3xl grid grid-cols-3 justify-center justify-items-stretch py-2 sm:grid-cols-1 sm:px-2 sm:py-0">
                ...
                <div className="flex gap-2 text-sm justify-items-center items-center">
                    <div>
